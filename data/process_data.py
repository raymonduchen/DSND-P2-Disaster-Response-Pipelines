...
def clean_data(df):
    ...
    # Drop all 0 column like 'child_alone' that contribute no further information to our ML pipeline
    categories.drop('child_alone', axis = 1, inplace = True)
    
    # According to https://knowledge.udacity.com/questions/136791, related value that equals 2 is more like "indirectly related". Therefore, we'll change all of them to 1.
